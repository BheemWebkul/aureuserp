...
return [
    'resources' => [
        'manage' => [
            ...
            ApplicantCategoryResource::class => ['view_any', 'view', 'create', 'update', 'delete', 'delete_any'],
            ...
            JobByPositionResource::class => ['view_any', 'update', 'restore', 'force_delete', 'force_delete_any', 'restore_any', 'reorder'],
            CandidateResource::class => ['view_any', 'view', 'create', 'update', 'delete', 'delete_any', 'restore', 'force_delete', 'force_delete_any', 'restore_any'],
            ApplicantResource::class => ['view_any', 'view', 'create', 'update', 'delete', 'restore', 'delete_any', 'force_delete', 'force_delete_any', 'restore_any'],
            ActivityTypeResource::class => ['view_any', 'view', 'create', 'update', 'delete', 'delete_any', 'restore', 'force_delete', 'force_delete_any', 'restore_any', 'reorder'],
